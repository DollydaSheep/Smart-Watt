...
export function Visualization3D({ devices, totalUsage, powerLimit, showLabels = false }: Visualization3DProps) {
  return (
    <div className="w-full max-w-2xl mx-auto md:mx-0 md:w-1/2 lg:w-2/5 xl:w-1/3 -mt-3 md:mt-0 flex flex-col items-center">
      {/* 3D Sphere */}
      <div className="w-full aspect-square bg-[#09090B] rounded-lg shadow-lg border border-transparent">
